      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <nav className="hidden md:flex space-x-8 items-center">
            <Link href="/questions" className="text-gray-600 hover:text-purple-900">
              Questionnaire
            </Link>
            <Link href="/recommendations" className="text-gray-600 hover:text-purple-900">
              Recommendations
            </Link>
            <Link href="/profile" className="text-gray-600 hover:text-purple-900">
              Profile
            </Link>
          </nav>
