// v1 Recommendations API endpoint that returns mock data
...
export default function handler(req, res) {
  ...
  console.log(`[Fallback API] /api/v1/recommendations accessed for session: ${sessionId}`);
  ...
  // This helps avoid confusion when testing as instant responses can be misleading
  setTimeout(() => {
